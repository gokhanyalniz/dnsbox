...
!==============================================================================
    ...
    subroutine vfield_norm2_orthogonal(vfieldk, res, allreduce)
        ...
        res1 = 0
        _loop_spec_begin
            dummy = conjg(vfieldk(ix,iy,iz,2)) * vfieldk(ix,iy,iz,2)
    ...
    end subroutine vfield_norm2_orthogonal
...
!==============================================================================
    ...
    subroutine vfield_power_mhd(vfieldk, cur_vfieldk, res, allreduce)
        ...
        _loop_spec_begin
            ...
            ! correct for double counting
            if (iy == 1) dummy = dummy * 0.5_dp
            res1 = res1 + 2.0_dp*(Ha**2/Re)*dummy%re
        _loop_spec_end
